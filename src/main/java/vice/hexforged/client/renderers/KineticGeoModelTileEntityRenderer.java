...
{
    static {
        AnimationController.addModelFetcher(KineticGeoModelTileEntityRenderer::fetchModel);
    }
    ...
    private static IAnimatableModel<Object> fetchModel(IAnimatable object)
    {
        if (object instanceof TileEntity)
        {
            ...
            if (renderer instanceof KineticGeoModelTileEntityRenderer)
            {
                val geoRenderer = ((KineticGeoModelTileEntityRenderer<?>) renderer);
                val animatedModel = geoRenderer.getGeoModelProvider();
